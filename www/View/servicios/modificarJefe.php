...
<form method="POST" action="consultarServicio.html">
	<table class="default">
		<tr> 
			...
			<td width="25%"> <input type="text" class="text" name="sPerio" value="Cada 2 Meses"/></td>
		</tr>
		<tr> 
		...
		<tr> 
			...
			<td width="25%"><input type="text" class="text" name="sFechaInicio" value="12/03/2005" /></td> 
			<td width="25%">Fecha fin: </td> 
			<td width="25%"> <input type="text" class="text" name="sFechaFin" value="12/03/2015" /></td>
		</tr>
		<tr> 
			<td width="25%">Coste: </td> 
			<td width="25%"><input type="text" class="text" name="sCoste" value="120'00 €/Mes" /></td> 
			<td width="25%">&nbsp;</td>
			<td width="25%">&nbsp;</td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		...
		<tr>
			<td colspan="4"><input type="submit" name="sModificar" value="Guardar"></td>
		</tr> 
	</table>
</form>