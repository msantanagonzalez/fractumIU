	...
	<?php foreach ($rows as $row) { ?>
		...
		<table class="default">
			<tr> 
				...
				<td width="25%"><input type="text" class="text"  value="<?php echo $row['costeIter']; ?>"/></td>
			</tr>
			<tr> 
				...
				<td width="25%"><input type="time" class="text" name="horaFin" value="<?php echo $row['hFin']; ?>" /></td>
			</tr>
			<tr> 
				<td>Estado Iteracion:</td>
				<td width="25%"><input type="date" class="text" name="estadoIteracion" value="<?php echo $row['estadoItera']; ?>" /></td> 	
			</tr>
			<tr>
				<td width="25%"><br>Descripci&oacute;n:</td>
				<td colspan='3' width="75%">
					<textarea style="resize:none; text-align:left;" style="t" rows="4">
