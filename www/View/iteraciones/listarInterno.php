...
<form method="POST" action="../../Controller/iteracionesController.php">
	<table class="default">
		...
		<tr> 
			...
			<td width="10%"><button><a href="../../Controller/iteracionesController.php?accion=Consulta&idIncid&nIteracion=<?php echo $row['idIncid']; $row['nIteracion'] ?>">Consultar</a></button></td>
		</tr>
		<?php } ?>
	</table>
</form>
