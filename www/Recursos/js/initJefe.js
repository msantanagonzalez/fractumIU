...
(function($) {
		...
		plugins: {
			layers: {
				sidePanel: {
					...
					height: '100%',
					hidden: true,
					html: '<div data-action="moveElement" data-args="sidebarJefe"></div>',
				...
				titleBar: {
					breakpoints: ['narrower', 'mobile'],
					height: 44,
					html: '<span class="toggle" data-action="toggleLayer" data-args="sidePanelJefe"></span><span class="title" data-action="copyText" data-args="header"></span>',
					position: 'top-left',
					side: 'top',
					width: '100%'
				}
	...
	$(function() {
		...
		// Sidebar height hack.
			var $sc = $('#sidebarJefe, #content'), tid;
