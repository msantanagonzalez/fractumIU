...
(function($) {
		...
		plugins: {
			layers: {
				...
				titleBar: {
					breakpoints: ['narrower', 'mobile'],
					height: 44,
					html: '<span class="toggle" data-action="toggleLayer" data-args="sidePanelI"></span><span class="title" data-action="copyText" data-args="logo"></span>',
					position: 'top-left',
					side: 'top',
					width: '100%'
				}
	...
	$(function() {
		...
		// Sidebar height hack.
			var $sc = $('#sidebarInterno, #content'), tid;
