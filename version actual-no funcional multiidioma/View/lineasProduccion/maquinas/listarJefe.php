...
<table class="default">
	...
	<table class="default">
		...
		<tr> 
			...
			<td width="10%"><button><a href="../../Controller/maquinasController.php?accion=Consulta&idMaq=<?php echo $row['idMaq'];?>"><?php echo $lang['CONSULTAR']; ?></a></button></td>
			<td width="10%"><button><a href="../../Controller/maquinasController.php?accion=Eliminar&idMaq=<?php echo $row['idMaq'];?>"><?php echo $lang['ELIMINAR']; ?></a></button></td>
		</tr>
		<?php } ?>
	</table>
</form>
