...
<table class="default">
    <tr>
    	...
    	<th width="20%"><?php echo $lang['USUARIO']; ?></th>
...
<div style="height:300px;width:auto;overflow-y: scroll;"><!--ESTO DA LUGAR AL SCROLL-->
	...
	<table class="default">
		...
		<tr> 
			...
			<td width="20%"><button href="../../Controller/maquinasController.php?accion=Consulta&idMaq=<?php echo $row['idMaq'];?>"><?php echo $lang['CONSULTAR']; ?></button></td>
		</tr>
		<?php } ?>
	</table>
</div>
